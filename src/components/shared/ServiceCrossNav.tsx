            ...
            {items.map((s) => {
              ...
              return (
                <Link
                  key={s.key}
                  href={s.href}
                  className="group flex items-start gap-3 p-4 bg-white rounded-xl border border-[var(--border-light)] hover:border-[var(--brand-primary)]/20 hover:shadow-[var(--shadow-card-hover)] transition-all"
                >
                  <span className="flex items-center justify-center w-9 h-9 rounded-lg bg-[var(--brand-primary-bg)] text-[var(--brand-primary)] group-hover:bg-[var(--brand-primary)] group-hover:text-white transition-colors flex-shrink-0">
                  ...
                  <ArrowRight className="h-4 w-4 text-[var(--text-muted)] group-hover:text-[var(--brand-primary)] group-hover:translate-x-0.5 transition-all flex-shrink-0 mt-1" />
                </Link>
              );
            })}
          </div>
