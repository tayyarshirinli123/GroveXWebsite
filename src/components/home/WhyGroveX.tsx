          ...
          {reasons.map((reason) => {
            ...
            return (
              <StaggerItem key={reason.key}>
                <div className="flex gap-5 p-6 bg-white rounded-xl shadow-[var(--shadow-sm)] transition-all duration-500 ease-out hover:-translate-y-0.5 hover:shadow-[var(--shadow-lg)]">
                  <div className="flex items-center justify-center w-12 h-12 rounded-lg bg-[var(--green-surface)] text-[var(--green-accent)] flex-shrink-0 transition-transform duration-400 group-hover:scale-105">
